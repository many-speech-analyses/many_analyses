...
<!-- TODO: add refs for variable conclusions -->
...
This can be problematic because humans show cognitive biases that can lead to erroneous inferences. <!-- I'd probably drop this. When we make unspecified decisions during data analysis we can stumble upon spurious results (most likely) as well as real results (less likely, still possible)... in other words it might not all be error... the issue is that we won't know the difference -->
...
<!-- SC: Rephrased the sentence to underline that the presence of cognitive biases is what creates the problem, rather than just not specifying decisions before hand. -->
...
<!-- TODO: add various references about transparency and repro -->
...
<!-- TODO: sum up crowd-sourced studies from different disciplines -->
SUM UP:
Neuroscience
Cognitive modeling
Clinical
...
<!-- SC: I like the distinction between data/data sets and data table. -->
...
<!-- SC: Added example from speech. Is it any good? -->
...
If, on the other hand, the speaker is worried that Liz goes to a crowded place like the supermarket, they might acoustically highlight the words *grocery store*.
...
Extra- and para-linguistic information, like speaker's intentions, levels of arousal or social identity, are also conveyed by broad-domain features, such as voice quality, rhythm, and intonation [@ogden2004; @foulkes2006; @white2009].
