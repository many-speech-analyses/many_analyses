...
Specifically, we discuss the impact of analytic decision making on research results obtained by N teams who had access to the same set of acoustic recordings in order to answer the same research question. One aim of this study is to replicate previous many-analyses projects, confirming the large amount of flexibility observed in statistical analyses. A second aim is to extend these findings and estimate the amount of flexibility observed during measurement and operationalization.
...
Extending on the many analyst approach, @landy2020crowdsourcing asked 15 research teams to independently design studies to answer the same research questions. Again, they found vast heterogeneity in researchers' conclusions which was not predicted by the researchers' expertise but by the research question itself. This is in line with a recent re-analysis of @silberzahn2018many by @auspurg2021has. The authors argue that the observed heterogeneity across analysts might be driven by flexibility in interpreting the research question. TRANSITION SENTENCE
