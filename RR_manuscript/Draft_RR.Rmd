...
Based on our personal experience with research in the field, it is common practice to test many different types of models, using many different types of measurements, to answer one research question.
...
Crowd-sourced projects such as the current one can shed light on the range of degrees of freedom during analysis and help produce a consensual estimated effect using meta-analytic techniques.
...
While some of our results can be informative for other disciplines that work with speech or audio/video signals, they might not be very informative for expected variation between analysts working in qualitative research fields.
