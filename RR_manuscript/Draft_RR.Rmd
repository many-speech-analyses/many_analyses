...
<!-- FIGURE -->
(ref:procedural) Experimental procedure timeline.
...
The analysis teams will register and answer a demographic and expertise questionnaire (`intake_form.pdf`).^[PDF versions of all the questionnaires mentioned in this paper are available at <https://github.com/many-speech-analyses/many_analyses/tree/master/docs/questionnaires>.]
...
The data will include the audio recordings with corresponding time-aligned transcriptions in the form of Praat TextGrid files.^[See <https://osf.io/rdtx5/?view_only=66989a3bbe034e188846e23f84913ffe>. Due to storage caps on the OSF, we will make the audio files available on <https://eudat.eu/catalogue/B2SHARE> in due course.]

Once their analysis is complete, they will answer a structured questionnaire (`analytical_quest.pdf`), providing information about their analysis technique, an explanation of their analytic choices, their quantitative results, and a statement describing their conclusions.
