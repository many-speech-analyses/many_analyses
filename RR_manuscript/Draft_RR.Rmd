...
Of the analyses submitted by the `r pull_from_tib(team_desc_df, stage, "Submitted", n_teams)` teams, the initiating authors identified analyses from `r pull_from_tib(team_desc_df, stage, "Final", n_teams)` teams to be eligible to be included in the meta-analytic model.
