...
In recent coordinated efforts to replicate published findings, the scientific disciplines have uncovered surprisingly low success rates in replication attempts [e.g., @open2015estimating; @camerer2018evaluating] leading to what is now referred to as the *replication crisis*.
...
For example, @flake2020 discuss the cascading impact different practices can have on several components of psychometric research.
