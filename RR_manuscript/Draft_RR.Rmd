...
<!-- TR: I count 9 GAMS, how can that amount to only 2%  -->
...
<!-- TR: what do you mean with "discarding random effect? Do you mean if we ignore the variation there?  The sentence does compute for me-->
<!-- TR: Now that we have the number for different acoustic operationalizations and the number for different statistical models we can calculate the possible unique combinations r nrow(unique_model_specs) * nrow(unique_acou_oper). I mention this in the discussion. If ok, delete comment-->
