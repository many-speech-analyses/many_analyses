...
While these teams in principle measured the same thing, they differed in analytical details of how f0 was operationalized (i.e. mean, min, max, or range) and how their statistical model was constructed (i.e. the number of predictors ranged from 1-3 and the number of random effect terms ranged from 1-4). 
As shown by [-@breznau2021observing], even seemingly inconsequential analytical choices can affect conclusions in non-trivial ways.
