...
<!-- TODO: ADD FORMULA of linear regression model to express majority of analysis -->
FORMULA
...
The likelihood of $\eta_i$ is assumed to be normally distributed [@knight2000].
The analysis teams will be included as a group-level effect (i.e., random effect).
For each population-level parameter $\beta_n$ (i.e., the fixed effects, see below), the model will include regularizing, weakly informative priors [@Gelman_2017], which are normally distributed and centered at 0 with a standard deviation of 1.
...
The analysis will be conducted in R [@R-base] and fit using Stan [@stan] via the R package brms [@brms].
<!-- TODO: add link to code of the meta-analytical model -->
The code for the model can be found here: INSERT LINK.

<!-- TODO: list predictors in meta-analytical model -->
...
### Exploratory road map
<!-- SC: change heading to your liking -->
