...
We then selected representative values of standard deviations for the three outcome measurements extracted either from specific segments or words.

Table XXX reports the minimum and maximum SD values taken from a representative range.
If we take segments, we have found duration measurements (as taken by the teams who used duration) to have standard deviations that range between 33.4 and 51.4 ms.
