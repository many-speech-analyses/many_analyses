...
For instance, if the competitor and target objects differ but their color did not (e.g. *yellow banana* vs *yellow tomato*), the noun is said to be in focus (the Noun Focus condition, NF).
...
The data set is constituded by audio recordings and annotation files in a format that is typical for the field.
