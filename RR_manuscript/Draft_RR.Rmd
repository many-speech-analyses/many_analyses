...
This means that the mean deviations of any individual team from the meta-analytic effect estimate range between $\pm$ `r round((meta_bm_prereg_tidy$conf.low[['sd_animal__Intercept']] * 1.96), 2)` to $\pm$ `r round((meta_bm_prereg_tidy$conf.high[["sd_animal__Intercept"]] * 1.96), 2)` (0.3 * 1.96, 0.07 * 1.96) in standard units at 95% probability.
