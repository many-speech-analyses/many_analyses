...
The data set given to the analysis teams comes from a study that investigated whether speakers acoustically modify utterances to signal typicality of noun/adjective combinations in referring expressions such as  *a blue banana* (atypical) vs *a yellow banana* (typical).
...
The teams were asked to answer the same questions as the study that generated the data set: *Do speakers acoustically modify utterances to signal atypical word combinations in referring expressions?*
...
## Phase 3: Peer Reviews of Analyses
