...
`r (round(random_n[[3,1]],2) * 100) %>% xfun::numbers_to_words() %>% str_to_sentence()` percent of linear models specified no random effects at all (without pooling their data), so effectively ignoring these non-independences [@hurlbert1984pseudoreplication].
