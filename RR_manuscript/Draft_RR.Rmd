...
We have evolved to filter the world in irrational ways (e.g., Tversky and Kahneman 1974), seeing coherent patterns in randomness (Brugger 2001), convincing ourselves of the validity of prior expectations (“I knew it”, Nickerson 1998), and perceiving events as being plausible in hindsight (“I knew it all along”, Fischhoff 1975). <!-- If helpful we could also give a concrete common example here, like regarding forecasting the weather or something --> 
...
These interpretation are either associated with an unknown amount of uncertainty or lend themselves to alternative interpretation if analyzed differently. <!-- RE analysed, if I'm not mistaken the rest of the manuscript is in American English, right? -->
However, instead of being critically evaluated, scientific results often remain unchallenged in the publication record. 
Critical reanalyses of published analytic strategies are uncommon because data sharing is still rare (Wicherts, Borsboom, Kats, & Molenaar, 2006, RECENT REF). <!-- aside from adding recent ref, consider adding counter point. Something to the effect of "despite recent efforts to improve transparency and reproducibility, i.e., OSF, IRIS. -->
...
In these studies the datasets were fixed and data collection or extraction could not be changed. <!-- any particular reason to favor data table over dataset? -->
...
For instance, one might use the adjective "yellow" to describe a banana in a situation in which there is a yellow and a less ripe green banana available.
...
<!-- I believe we were still going to do this --> 
...
After providing this rating, the reviewer will be presented with this prompt, in multiple-choice format: “Would the analytical methods presented produce an analysis that is (a) publishable as is, (b) publishable with minor revision, (c) publishable with major revision, (d) deeply flawed and unpublishable?” 
