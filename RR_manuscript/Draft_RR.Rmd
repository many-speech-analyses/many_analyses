...
The combinations were either typical (e.g. *orange mandarin*), medium typical (e.g. *greem tomato* ), or atypical (e.g. *yellow cherry*), as established by a norming study that was conducted prior to the production experiment (see HERE^[Temporary link: <https://osf.io/5agn9/?view_only=3429acfd8eae4f0aafe2e17ad5b0983f>]).
...
- *Average peer-review rating* [numeric], as the mean of the overall peer-review ratings for each analysis.
