...
On the one hand, the second non-preregistered model reveals that the posterior estimate for model ID is identical to that of the first non-preregistered model.
