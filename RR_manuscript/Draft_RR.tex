...
At the end of Phase 2 (primary data analysis), the teams have submitted a grand total 170 individual models to answer the research question, with a mean of 3.6 models per team.
...
33\% of models used a measure of duration as the outcome variable, 36\% used fundamental frequency (f0), 15\% used vowel formants, 14\% intensity, and 3\% other measures.
...
Among the possible operationalizations, 78\% of models contained typicality as a categorical variable (e.g.~atypical vs.~typical), 19\% used a continuous typicality scale from 0-100 by calculating the mean typicality for each word combination as obtained from the norming study, while 1\% of the models used the median typicality rating.
...
The mean rating of the acoustic analyses, on a scale from 0 to 100, is 74.6 (SD = 11.1).
The mean rating of the statistical analysis is 73.9 (SD = 14.1).
