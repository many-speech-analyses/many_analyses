...
66\% specified random intercepts only, and 29\% specified both random intercepts and random slopes to account for the non-independence.
...
Analyses exhibited at least 45 unique ways of operationalizing the acoustic signal alongside 52 unique ways of constructing their statistical model, amounting to 2340 possible unique combinations.
