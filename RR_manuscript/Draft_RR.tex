...
At the end of Phase 2 (primary data analysis), the teams have submitted a grand total 104 individual models to answer the research question, with a mean of (SD: ) models per team.
...
\caption{\label{tab:team-descriptives-table}Descriptive statistics for teams included in the 
    meta-analysis (n = 30).}
\centering
...
Overall peer review rating & 39.0--88.7 & 70.0 (14.3)\\
Acoustic analysis rating & 41.2--88.3 & 71.5 (13.9)\\
Prior belief in $H_{1}$ & 48.5--92.0 & 69.2 (11.3)\\
Self-report statistical ability & 33.0--93.3 & 69.5 (16.5)\\
Years since PhD & -3.8--12.4 & 4.8 (4.2)\\
n. models & 1--16 & 3.7 (3.4)\\
\bottomrule
\end{tabular}
\end{table}
...
\caption{\label{tab:categorical-descriptives-table}Descriptive statistics for model stuff.}
\centering
\fontsize{11}{13}\selectfont
...
Metric & Type & n & \%\\
\midrule
Framework & Frequentist & 86 & 82.7\\
 & Bayesian & 18 & 17.3\\
 &  &  & \\
Model & Linear model & 102 & 98.1\\
 & GAM & 1 & 1.0\\
 & Other & 1 & 1.0\\
 &  &  & \\
Outcome & F0 & 37 & 35.6\\
 ...
 & Other & 3 & 2.9\\
 &  &  & \\
Temporal window & Segment & 47 & 45.6\\
 & Word & 45 & 43.7\\
 & Other & 4 & 3.9\\
 & Sentence & 4 & 3.9\\
 & Phrase & 3 & 2.9\\
 &  &  & \\
Typicality operationalization & Categorical & 75 & 72.8\\
...
Of the submitted analyses, 37 claimed to have found a statistically reliable effect (21.76\%).
Nine teams out of the thirty (30\%) submitting analyses reported at least one found effect.

\begin{table}

\caption{\label{tab:stats-descriptives-table}Descriptive statistics for statistical analyses included in the 
    meta-analysis (n = 30).}
\centering
\fontsize{11}{13}\selectfont
\begin{tabular}[t]{lcr}
...
The mean rating of the acoustic analyses, on a scale from 0 to 100, is 74.5 (SD = 11.2, see Table \ref{tab:team-descriptives-table}).
