...
On the other hand, the posterior 95\% CrI for team in the second non-preregistered model is 0-0.05 standard units (\(\beta\) = 0.02, SD = 0.01), corresponding to a mean deviation range of ±0.1 standard units.
...
The meta-analytic model estimates the range of probable values of the standardized effect size to be between -0.022 and 0.023 standard units (95\% CrI, mean = 0.001).
...
In the first model, the meta-analytic intercept estimate is between -0.01 and 0.04 standard units (95\% CrI, mean = 0.016).
...
Notably, while the majority of models yields inconclusive results, there are 25 model estimates for which the 95\% credible interval does not contain zero (15\%).
