...
If, on the other hand, there actually was an underlying relationship, our results would suggest a concerning false negative rate of `r round(1-perc_atleast_1, 1)`%, with the majority of teams not detecting the effect. 
