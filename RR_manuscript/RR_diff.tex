...
%DIF DEL RR_stage_2.tex   Fri Jan 20 09:31:08 2023
%DIF ADD RR.tex           Fri Jan 20 09:18:27 2023
...
Of the models with divergent transitions (n = 10), the number of divergences ranged from 1 to 143 (143 represents 3.58\% of total number of samples), which the authors deemed not to be problematic.
}\DIFaddend 
...
Of the \DIFdelbegin \DIFdel{analysis }\DIFdelend \DIFaddbegin \DIFadd{analyses }\DIFaddend submitted by the 46 teams, the initiating authors identified analyses from \DIFdelbegin \DIFdel{30 }\DIFdelend \DIFaddbegin \DIFadd{33 }\DIFaddend teams to be eligible to be included in the meta-analytic model.
...
These standard deviations allow us to convert the \DIFdelbegin \DIFdel{meta analytic }\DIFdelend \DIFaddbegin \DIFadd{meta-analytic }\DIFaddend estimates into milliseconds by multiplying those values with the \DIFaddbegin \DIFadd{meta-analytic estimates }\DIFaddend standard units.
...
}\DIFdelend First of all, through sharing of materials, data and statistical protocols, we can make our idiosyncratic choices transparent to others \citep{munafo2017manifesto, vazire2017quality}.
...
Second, making analytic pathways completely re-traceable \DIFdelbegin \DIFdel{does }\DIFdelend \DIFaddbegin \DIFadd{and preregistering them in advance do }\DIFaddend not change the fact that \DIFdelbegin \DIFdel{analysts }\DIFdelend \DIFaddbegin \DIFadd{different analysts might }\DIFaddend apply different analytic approaches \DIFaddbegin \DIFadd{(preregistered or not)}\DIFaddend .
