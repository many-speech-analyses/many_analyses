...
Of the submitted teams, teams consisted of an average of `r team_desc_list$Final$mean_size$val` analysts (sd = `r team_desc_list$Final$sd_size$val`). 
...
<!-- TODO: list co-occurring predictors -->
...
According to the meta-analytic model, the group-level standard deviation is between 0.11 and 0.15 standard units, at 95% confidence.
