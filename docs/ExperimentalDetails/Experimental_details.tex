...
\hypersetup{
  pdftitle={Production study: Methodological details},
  hidelinks,
...
{\centering \includegraphics[width=0.6\linewidth,frame]{sample_experiment_screen_competitor} 
...
{\centering \includegraphics[width=0.6\linewidth,frame]{sample_experiment_screen_target} 
