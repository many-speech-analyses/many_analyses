...
- Submit your analysis report (as an individual or in a team), in the form of "Methods" and "Results" sections, and fill in a data analysis questionnaire by 2022-04-15, 23.59 UTC.
...
Each contributor is personally accountable for the accuracy and integrity of their work on this project. This includes ensuring that:

1. You are operating in accordance with your local research rules and regulations.
2. Your specific research products are honest and accurate (e.g., data, translations, code).
3. Your description of your role on the project is accurate.

### Press

Initial press releases will be coordinated by the Project coordinators. All collaborators are strongly encouraged to speak to the press, but are expected to:

1. Emphasize the highly collaborative nature of the research project.
2. Encourage the interviewer to reach out to various members of the team.
