...
Currently, the GitHub repo "many_speech" is not available. We have added a zipped version of the GH repo archive (downloaded from OSF) to the OSF component.

```{r}
#| label: cromileptes_saxatilis

unzip(here("data", "analyses", "jvc", "cromileptes_saxatilis", "many_speech.zip"), exdir = here("data", "analyses", "jvc", "cromileptes_saxatilis"))

cromileptes_saxatilis_durs <- read_csv(here("data", "analyses", "jvc", "cromileptes_saxatilis", "many_speech", "processed_data", "NF_durations.csv")) %>% 
  filter(typicality != "medium")
...
unzip(here("data", "analyses", "jvc", "trapezia_cantonensis", "audio_chunks.zip"), exdir = here("data", "analyses", "jvc", "trapezia_cantonensis"))
...
beast_path <- "./data/analyses/jvc/trapezia_cantonensis/audio_chunks/"
