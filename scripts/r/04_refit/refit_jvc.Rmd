...
teams <- tribble(
  ...
  "gnathosaurus_canadensis",  FALSE,          FALSE,
  "gymnothorax_spinulosus",   FALSE,          FALSE,
  "haematopus_fossor",        TRUE,           TRUE,
  "lasionycteris_altavela",   TRUE,           TRUE,
  "linckia_nattereri",        FALSE,          FALSE,
  "lycodes_bradfieldi",       FALSE,          FALSE,
  "naso_cassivellaunos",      FALSE,          FALSE,
  "trapezia_cantonensis",     FALSE,          FALSE,
  "trigonias_lachneri",       FALSE,          FALSE,
  )
