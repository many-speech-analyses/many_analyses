...
### Load data ###
#################
d <- read_delim("./data/analyses/tr/chelonia_brummeri/analysis/german_msa_prosody.txt", delim = "\t", escape_double = FALSE, trim_ws = TRUE)
syll <- read_csv("./data/analyses/tr/chelonia_brummeri/analysis/syllables.csv")
...
# read csv
msa_data_raw <- read_csv("./data/analyses/tr/procambarus_mahogoni/MSA-data.csv")
